...
<head>
    <title>
        【洛阳站】仁和爱心公益行——只需33元，68元益生菌拿到手！还能为福利院儿童送健康！
    </title>
</head>
<body>
                                                                        ...
                                                                        <section data-role="outer"
                                                                            ...
                                                                            <p style="color: rgb(62, 62, 62); line-height: 25.6px; white-space: normal; text-align: center;">
                                                                                <span style="color: #262626;"><strong><span
                                                                                        ...
                                                                                        style="color: #FF0000;">洛阳各大母婴店</span></span></strong></span>
                                                                            </p>
                                                                            <p style="color: rgb(62, 62, 62); line-height: 25.6px; white-space: normal; text-align: center;">
                                                                                <span style="color: #262626;"><strong><span
                                                                                ...
                                                                                <section style="margin: 10px auto;">
                                                                                    <section
                                                                                        ...
                                                                                        <p><span
                                                                                                ...
                                                                                                style="color: #FF0000;">洛阳市各大母婴门店</span><span
                                                                                                style="color:#3e3e3e">特邀您参加大型爱心公益活动——为洛阳儿童福利院的儿童送去健康。<strong>活动如下：</strong></span></span>
                                                                                        </p>
                                                                            ...
                                                                            <section
                                                                                ...
                                                                                <%
                                                                                    ...
                                                                                    String sql = "select id,STORE_NAME,address,CONTACTS,tel,pic_path from store_info where city='洛阳'";
